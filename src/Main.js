      ...
      <div className="activity-box">
        ...
        <div className="activity-list">
          <div className="activity-item">
            ...
            <span className="activity-desc">다양한 분야의 현직자분들을 모셔서 세미나 진행</span>
          </div>
          <div className="activity-item">
            <span className="check-icon">✔</span>
            <span className="activity-label">Tools Growing</span>
            <span className="activity-desc">Experts 활동 전, 소규모 스터디 활동</span>
          </div>
          <div className="activity-item">
            <span className="check-icon">✔</span>
            <span className="activity-label">Tools Experts</span>
            <span className="activity-desc">팀을 꾸려 한 학기 동안 진행하는 프로젝트 활동</span>
          </div>
          <div className="activity-item">
            <span className="check-icon">✔</span>
            <span className="activity-label">Tools Mileage</span>
            <span className="activity-desc">한 해 동안 열심히 활동한 부원들 수상</span>
          </div>
        </div>
      </div>
